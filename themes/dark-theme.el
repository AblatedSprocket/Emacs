;;; dark-theme.el --- My dark theme for Emacs
;;; Commentary:
;;; This theme is based on a color scheme derived from a background
;;; Code:
(deftheme dark
...
(let* ((class '((class color) (min-colors 89)))
       (background "#2f383e")
       (faded-background "#374247")
       (current-line "#374247")
       (far-background "#4a555b")
       (header-color "#C8E6C9")
       (subtle "#525c62")
       (selection "#404c51")
       (secondary-selection "#374247")
       (foreground "#ffefe7")
       (comment "#7f8c8d")
       (red "#e67e80")
       (faded-red "#b7596a")
