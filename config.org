...
(setq auto-save-default nil ;; don't autosave
      ...
      completion-styles '(basic partial-completion flex) ;; Provide fuzzy search matching.
...
(add-hook 'elisp-mode-hook 'highlight-todo)
...
HL-Todo highlights to-do items in buffers where the mode is active.
...
I haven't had the opportunity to use this extensively yet. It might not.
