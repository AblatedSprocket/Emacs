...
*** ACTIVE VS Code Dark Plus

I don't particularly like much about VS Code, but it sure does have good default themes. Luckily ports exist

#+BEGIN_SRC emacs-lisp :padline no
  (require-package 'vscode-dark-plus)
  (require 'vscode-dark-plus)
...
I've moved to Evil mode! Maybe someday I'll transition all of the keybindings I've made for all of the other modes I've added.
